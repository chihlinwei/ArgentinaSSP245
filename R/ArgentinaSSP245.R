#' Data package for seafloor climage change (ArgentinaSSP245)
#'
#' ArgentinaSSP245 package contains ensemble model average of CMIP6 historical and ssp245 climate change projections on the seafloor for Argentina EEZ.
...
#' The ensemble averages of various model statistics were calculated among the five models for the periods of 1950 to 2000 (historial), 2041 to 2060 (ssp245) and 2081 to 2100 (ssp245).
