...
* Show the average projections for seafloor climate variables including export POC flux (epc), dissolved oxygen concentration (o2), pH values (ph), and potential temperature (thetao) from 2081 to 2100.

* Display the average seafloor climate changes for export POC flux (epc), dissolved oxygen concentration (o2), pH values (ph), and potential temperature (thetao) between 1950 to 2000 and 2081 to 2100.

* Show the average climate change hazards for export POC flux (epc), dissolved oxygen concentration (o2), pH values (ph), and potential temperature (thetao) from 2081 to 2100.

* Display the cumulative impacts of climate change hazards for export POC flux (epc), dissolved oxygen concentration (o2), pH values (ph), and potential temperature (thetao) from 2081 to 2100.

* Show the average seafloor gradient-based climate velocity magnitudes from 2081 to 2100.

* Display the cumulative impacts of climate velocity magnitudes for export POC flux (epc), dissolved oxygen concentration (o2), pH values (ph), and potential temperature (thetao) from 2081 to 2100.
