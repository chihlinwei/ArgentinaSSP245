...
* Download the occurrence data for Southwest Atlantic butterfish (Stromateus brasiliensis) and Longtail southern cod (Patagonotothen ramsayi) from OBIS, and display them on maps. 

* Construct species distribution models using historical data from 1950 to 2000 with Maxent. Then, predict and map the historical and future species habitat suitability from 2041 to 2060 and from 2081 to 2100.
